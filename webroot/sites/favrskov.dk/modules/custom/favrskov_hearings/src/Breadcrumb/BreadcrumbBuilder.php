...
class BreadcrumbBuilder implements BreadcrumbBuilderInterface {
  ...
  public function applies(\Drupal\Core\Routing\RouteMatchInterface $route_match) {
    ...
    if (!$route_entity || $route_entity->getEntityTypeId() != 'node' || $route_entity->bundle() != 'hearing_page') {
      return FALSE;
    }
  ...
  public function build(RouteMatchInterface $route_match) {
    ...
    if ($route_entity && $route_entity->getEntityTypeId() == 'node' && $route_entity->bundle() == 'hearing_page') {
      ...
      $links[] = new Link('Demokrati', Url::fromUserInput('/demokrati'));
      $links[] = new Link('Høringer', Url::fromUserInput('/demokrati/hoeringer'));
