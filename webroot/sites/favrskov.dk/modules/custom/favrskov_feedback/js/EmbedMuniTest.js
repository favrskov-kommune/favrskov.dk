...
var chatbotName = "Muni"; // The name/header text of your chatbot (max chars is 22). In order to change chatbot name in the dialog also a context variable must be updated through the administration application.
