(function ($) {
  Drupal.behaviors.favrskovthemeSwiper = {
    attach: function (context, settings) {
      //Swiper Content
      if ($('.swiper-content', context).length != 0) {
        var contentSwiper = $('.swiper-content', context).swiper({
          autoplay: 8000,
          loop: true,
        ...
        consrolsLeftRightSwiper(contentSwiper);
        ...
        // Controls swiper left/right
        function consrolsLeftRightSwiper(contentSwiper) {
