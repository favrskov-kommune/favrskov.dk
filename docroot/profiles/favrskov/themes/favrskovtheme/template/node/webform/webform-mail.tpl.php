 ...
 */
?>
<?php if (($email['email'] * 1) > 0): ?>
  <?php print ($email['html'] ? '<p>' : '') . t('Thank you for your statement.'). ($email['html'] ? '</p>' : ''); ?>

  <?php print ($email['html'] ? '<p>' : '') . t('This email may not be answered.'). ($email['html'] ? '</p>' : ''); ?>
