...
curl -X POST -H 'Content-type: application/json' --data '{"attachments": [{"title": "Favrskov.dk", "title_link": "'$7'", "text": ":azure-logo: Starting release of `'$2'` to <'$7'|'$8'>","color": "E6E6E6","mrkdwn_in": ["title","text"]}]}' $6
